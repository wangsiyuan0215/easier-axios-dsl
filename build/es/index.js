...
var Fr = oi, Yt = Fr.custom, Zt = Xn(Yt) ? Yt : null, hi = function e(r, t, n, a) {
  ...
  if (Ci(r)) {
    for (var b = "<" + Jt.call(String(r.nodeName)), d = r.attributes || [], A = 0; A < d.length; A++)
  ...
  if (mi(r)) {
    var y = Fe(r, p);
    return !("cause" in Error.prototype) && "cause" in r && !Kn.call(r, "cause") ? "{ [" + String(r) + "] " + B.call(kt.call("[cause]: " + p(r.cause), y), ", ") + " }" : y.length === 0 ? "[" + String(r) + "]" : "{ [" + String(r) + "] " + B.call(y, ", ") + " }";
  }
...
var Zr = Kr, me = ti, Ni = hi, Fi = Zr("%TypeError%"), De = Zr("%WeakMap%", !0), Ue = Zr("%Map%", !0), Di = me("WeakMap.prototype.get", !0), Ui = me("WeakMap.prototype.set", !0), Mi = me("WeakMap.prototype.has", !0), Bi = me("Map.prototype.get", !0), Li = me("Map.prototype.set", !0), qi = me("Map.prototype.has", !0), et = function(e, r) {
  ...
  if (fu(d) || Mr.isBuffer(d)) {
    if (i) {
      ...
      if (n === "comma" && h) {
        for (var U = iu.call(String(d), ","), k = "", F = 0; F < U.length; ++F)
          k += (F === 0 ? "" : ",") + v(i(U[F], T.encoder, m, "value", p));
        return [v(D) + (a && z(d) && U.length === 1 ? "[]" : "") + "=" + k];
      }
